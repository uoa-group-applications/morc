...
public class BodyProcessorTest extends Assert implements MorcMethods {

    @Test
    public void testXmlRuntimeTestResource() throws Exception {
        MorcTestBuilder.XmlRuntimeTestResource resource =
                new MorcTestBuilder.XmlRuntimeTestResource(new PlainTextTestResource("<foo/>"), getXmlUtilities());
