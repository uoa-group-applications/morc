 ...
 */
public class HttpErrorMockDefinitionBuilder extends SyncMockDefinitionBuilderInit<HttpErrorMockDefinitionBuilder, TestResource> {
    ...
    public MockDefinition build(MockDefinition previousDefinitionPart) {
        this.addRepeatedProcessor(new Processor() {
            ...
            public void process(Exchange exchange) throws Exception {
                logger.trace("Setting response code to {} for endpoint {}", statusCode, getEndpointUri());
